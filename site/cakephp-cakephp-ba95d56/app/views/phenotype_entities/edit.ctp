<div class="phenotypeEntities form">
<?php echo $this->Form->create('PhenotypeEntity');?>
	<fieldset>
 		<legend><?php __('Edit Phenotype Entity'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('PhenotypeEntity.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('PhenotypeEntity.id'))); ?></li>
