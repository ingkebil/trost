...
#        echo $this->Form->input('person_id', array('empty' => false, 'after' => $this->Html->link(__('The list is wrong!', true), 'mailto:billiau@mpimp-golm.mpg.de?subject=TROST')));
        ...
        echo $this->Form->input('Keyword', array('empty' => false, 'label' => __('To select several keywords please hold down the ctrl key.', true))); // use the ModelName so multiple selection is possible
